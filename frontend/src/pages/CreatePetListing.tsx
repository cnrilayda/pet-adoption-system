  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const requestData = {
        ...
        isVaccinated: formData.isVaccinated ? formData.isVaccinated === 'true' : null,
        isNeutered: formData.isNeutered ? formData.isNeutered === 'true' : null,
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Örn: Sevecen Golden Retriever yeni ailesini arıyor"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Hayvanınız hakkında detaylı bilgi verin: özellikleri, karakteri, sahiplenmek isteyenler için önemli notlar..."
                required
              />
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleInputChange('isVaccinated', e.target.value)}
                >
